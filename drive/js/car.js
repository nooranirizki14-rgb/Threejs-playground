...
export class Car {
  ...
  buildWipers() {
    ...
    for (const px of [-0.35, 0.35]) {
      ...
      const arm = new THREE.Mesh(new THREE.BoxGeometry(0.03, 0.5, 0.025), armMat);
      arm.position.y = 0.25;
      inner.add(arm);
      const blade = new THREE.Mesh(new THREE.BoxGeometry(0.045, 0.62, 0.03), armMat);
